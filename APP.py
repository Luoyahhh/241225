...
BMI = st.sidebar.number_input("特征 BMI (范围: 10.81-40.23)", min_value=10.81, max_value=40.23, value=30)
CL = st.sidebar.number_input("特征 CL (范围: 0.9-2.3)", min_value=0.9, max_value=2.3, value=2.0)
WT = st.sidebar.number_input("特征 WT (范围: 15.5-123)", min_value=15.5, max_value=123, value=20.0)
TBIL = st.sidebar.number_input("特征 TBIL (范围: 2.3-53.8)", min_value=2.3, max_value=53.8, value=13)
AGE = st.sidebar.number_input("特征 AGE (范围: 5-85)", min_value=5, max_value=85, value=10.0)
SCR = st.sidebar.number_input("特征 SCR (范围: 23.0-168.0)", min_value=23, max_value=168, value=45.0)
BUN = st.sidebar.number_input("特征 BUN (范围: 0.95-12.51)", min_value=0.95, max_value=12.51, value=12.0)
ALB = st.sidebar.number_input("特征 ALB (范围: 0.19-68.0)", min_value=0.19, max_value=68, value=5.0)
UA = st.sidebar.number_input("特征 UA (范围: 78.0-770.0)", min_value=78, max_value=770.0, value=79.0)
GFR = st.sidebar.number_input("特征 GFR (范围: 29.0-287.21)", min_value=29.0, max_value=287.21, value=30.0)
HB = st.sidebar.number_input("特征 HB (范围: 84.0-182.0)", min_value=84.0, max_value=182.0, value=117.0)
NA = st.sidebar.number_input("特征 NA (范围: 128.0-151.4)", min_value=128.0, max_value=151.4, value=117.0)
ALT = st.sidebar.number_input("特征 ALT (范围: 4.0-873.0)", min_value=4.0, max_value=873.0, value=117.0)
